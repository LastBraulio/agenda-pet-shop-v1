...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <h1>Crear <span class="badge badge-secondary">Reservas</span></h1>
                <form>
                    <div class="row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputfecha1">Fecha Inicio</label>
                                <input type="date" class="form-control" id="inputfecha1">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputfecha2">Fecha Final</label>
                                <input type="date" class="form-control" id="inputfecha2">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <h1>Agregar  <span class="badge badge-secondary">Mascota</span></h1>
    ...
    async function obtener_names(){
        await fetch('./api/api_contact.php?v=search_contacts&id='+id_name_contact.value)
			...
			.then(function(data){
                ...
                button_reservas.disabled = false;
                swal("Buen Trabajo!", "Hola "+data[1]+" y Bienvenido", "success");
