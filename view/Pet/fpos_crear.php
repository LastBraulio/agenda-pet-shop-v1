    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="jumbotron shadow-box">
                <h1>Crear <span class="badge badge-warning">Mascota FPOS X AGENDA</span></h1>
                <form>
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $_GET['id_contact']; ?>" id="input_idcont" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo $array_pets_name[0]; ?>" id="inputname" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputapellido">Apellido</label>
                                <input type="text" class="form-control" value="<?php echo $array_pets_name[1]; ?>" id="inputapellido" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputnames">Nombre Completo</label>
                            <input type="text" class="form-control" value="<?php echo $_GET['names']; ?>" id="inputnames" required>
                        </div>
